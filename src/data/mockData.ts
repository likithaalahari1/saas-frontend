...
export const initialAccounts: SocialAccount[] = [
  ...
  },
  {
    id: 'acc-3',
    platform: 'linkedin',
    name: 'Acme Inc. Company Page',
    username: 'linkedin.com/company/acme',
    avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=150&q=80',
    connected: true,
    lastSynced: '1 hour ago',
    postsPublishedCount: 64,
    followersCount: 19400,
    health: 'warning',
    warningMessage: 'OAuth token expires in 3 days. Re-authorization recommended.'
  },
  {
    id: 'acc-4',
    platform: 'twitter',
  ...
  },
  {
    id: 'acc-5',
    platform: 'tiktok',
    name: 'Acme TikTok Studio',
    username: '@acme_tok',
    avatar: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=150&q=80',
    connected: true,
    lastSynced: '12 mins ago',
    postsPublishedCount: 45,
  ...
  },
  {
    id: 'acc-6',
    platform: 'youtube',
    name: 'Acme Studios Channel',
    username: 'youtube.com/@acmestudios',
